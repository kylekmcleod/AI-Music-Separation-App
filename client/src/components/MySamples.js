...
export default function MySamples() {
  ...
  return (
    ...
    <Typography variant="h6" sx={{ textAlign: 'left', mt: 2, color: 'text.secondary' }}>
      <Typography variant="h2" sx={{ textAlign: 'left', mt: 2, fontWeight: 'bold', color: 'white' }}>
        My Samples
      </Typography>
      Browse and search through your saved samples.
    </Typography>
