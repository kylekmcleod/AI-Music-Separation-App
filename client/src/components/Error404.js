  ...
  return (
    <ThemeProvider theme={showCustomTheme ? LPtheme : defaultTheme}>
      ...
      <Box sx={{ bgcolor: 'background.default' }}>
        ...
        >
          <Typography variant="h2" sx={{ mt: 30, color: 'white', textAlign: 'center'}}>
            Error <strong style={{ color: '#EF4A40' }}>404</strong>

            <Typography variant="h5" sx={{ pb: 20, fontWeight: '300', color: 'white', textAlign: 'center' }}>
